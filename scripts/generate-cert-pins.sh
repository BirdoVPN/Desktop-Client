...
echo "   birdo-client-desktop/src-tauri/src/api/client.rs"
echo ""
echo "2. Copy the DoH provider pins into the respective DoHProvider structs in:"
echo "   birdo-client-desktop/src-tauri/src/vpn/doh.rs"
...
echo "   birdo-client-mobile/app/src/main/java/app/birdo/vpn/di/NetworkModule.kt"
echo ""
